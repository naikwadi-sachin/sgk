package org.sgk.bank.controller;

import org.sgk.bank.AccountNotFoundException;
import org.sgk.bank.AccountService;
...
public class DepositController {
	...
	public String deposit(@RequestParam("accountNo") String accountNo,
			@RequestParam("balance") double amount, ModelMap model)
